...
# l = [394,395,396,397,398,399,400]


for image_row in range(1, 2):
    for image_column in os.listdir(MODULE_FOLDER + '/../data-set/unclean/mouse_crop/tobeCrop/'):

        # Path of image file to be read image_read_path=str(image_column)+'.png'
        image_read_path = MODULE_FOLDER + '/../data-set/unclean/mouse_crop/tobeCrop/' + image_column
        ...
        if input_img is not None:
            ...
            # cv2.WINDOW_AUTOSIZE = Default flag. Auto resize window size to fit an image.
            ...
            while True:
                ...
                if len(roi) == 4:
                    # Make a copy of original image before drawing rectangle on it
                    ...
                    cv2.imwrite(MODULE_FOLDER + '/../data-set/unclean/mouse_crop/cropped/' +
                                str(image_column) + '.png', crop_img)
